...
namespace HackerNews.Domain.Abstract
{
    ...
    public class HackerNewsServiceTests
    {
        ...
        /// <summary>
        /// Tests the GetNewStoriesAsync method when the cache is available.
        /// </summary>
        [Fact]
        public async Task GetNewStoriesAsync_ShouldReturnCachedList_WhenCacheIsAvailable()
        {
            ...
            //_memoryCacheMock.Setup(m => m.TryGetValue("NewStories", out cachedList)).Returns(true);
            _memoryCacheMock.Setup(m => m.TryGetValue(It.IsAny<object>(), out cachedList)).Returns(false);
        ...
        /// <summary>
        /// Tests the GetNewStoriesAsync method when the cache is not available.
        /// </summary>
        [Fact]
